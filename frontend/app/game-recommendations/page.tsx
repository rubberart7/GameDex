...
const RecommendationsPage: React.FC = () => { // Changed component name
  return (
    <div className="bg-slate-950 text-slate-100 min-h-screen">
      ...
      <main className="container mx-auto px-4 py-8 flex flex-col">
        <section className="mb-8 pb-4 border-b border-slate-800 flex flex-col items-center">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-100 mb-2">Recommended for You</h1> {/* Changed text */}
          <p className="text-lg text-gray-400">Personalized game suggestions based on your taste.</p> {/* Changed text */}
        </section>
...
export default RecommendationsPage; // Export the new component